...
ROOT_URLCONF = 'roll_and_resin.urls'
...
WSGI_APPLICATION = 'roll_and_resin.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'roll-and-resin'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'melody.lisa1990@gmail.com'
else:
